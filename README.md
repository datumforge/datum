...
1. [postgres](https://www.postgresql.org/) - currently planned database, but also offer support for [libsql](https://turso.tech/libsql) and [sqlite](https://www.sqlite.org/) 
