...
var cmd = &cobra.Command{
	...
	Short: "the subcommands for working with datum orgMembershipHistories",
}
...
func consoleOutput(e any) error {
	...
	switch v := e.(type) {
	case *datumclient.GetAllOrgMembershipHistories:
		var nodes []*datumclient.GetAllOrgMembershipHistories_OrgMembershipHistories_Edges_Node
		...
		e = nodes
	case *datumclient.GetOrgMembershipHistories:
		var nodes []*datumclient.GetOrgMembershipHistories_OrgMembershipHistories_Edges_Node
	...
	var list []datumclient.OrgMembershipHistory

	err = json.Unmarshal(s, &list)
	if err != nil {
		var in datumclient.OrgMembershipHistory
...
func tableOutput(out []datumclient.OrgMembershipHistory) {
