...
-- Set sequence for "group_settings" table
INSERT INTO sqlite_sequence (name, seq) VALUES ("group_settings", 4294967296);
...
-- Set sequence for "integrations" table
INSERT INTO sqlite_sequence (name, seq) VALUES ("integrations", 8589934592);
...
-- Set sequence for "organizations" table
INSERT INTO sqlite_sequence (name, seq) VALUES ("organizations", 12884901888);
...
-- Set sequence for "sessions" table
INSERT INTO sqlite_sequence (name, seq) VALUES ("sessions", 17179869184);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("users", 21474836480);
...
-- Add pk ranges for ('groups'),('group_settings'),('integrations'),('organizations'),('sessions'),('users') tables
INSERT INTO `ent_types` (`type`) VALUES ('groups'), ('group_settings'), ('integrations'), ('organizations'), ('sessions'), ('users');
