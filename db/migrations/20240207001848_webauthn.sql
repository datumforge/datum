...
CREATE TABLE `webauthns` (`id` text NOT NULL, `created_at` datetime NOT NULL, `updated_at` datetime NOT NULL, `created_by` text NULL, `updated_by` text NULL, `deleted_at` datetime NULL, `deleted_by` text NULL, `name` text NOT NULL, `user_id` text NOT NULL, `credential_id` text NOT NULL, `public_key` blob NOT NULL, `attestation_type` text NOT NULL, `aaguid` text NOT NULL, `sign_count` integer NOT NULL, `transports` json NOT NULL, `flags` json NOT NULL, `authenticator` json NOT NULL, `backup_eligible` bool NOT NULL, `backup_state` bool NOT NULL, `owner_id` text NOT NULL, PRIMARY KEY (`id`), CONSTRAINT `webauthns_users_webauthn` FOREIGN KEY (`owner_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION);
