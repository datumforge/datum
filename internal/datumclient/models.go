...
type Permission struct {
	...
	RolePermission []*RolePermission `json:"rolePermission,omitempty"`
}
...
type PermissionConnection struct {
	// A list of edges.
	Edges []*PermissionEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type PermissionEdge struct {
	// The item at the end of the edge.
	Node *Permission `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}
...
type RolePermissionConnection struct {
	// A list of edges.
	Edges []*RolePermissionEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type RolePermissionEdge struct {
	// The item at the end of the edge.
	Node *RolePermission `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}
...
type UpdateRoleInput struct {
	...
	IsDisabled          *bool      `json:"isDisabled,omitempty"`
	CreatedTime         *time.Time `json:"createdTime,omitempty"`
	AddPermissionIDs    []string   `json:"addPermissionIDs,omitempty"`
	RemovePermissionIDs []string   `json:"removePermissionIDs,omitempty"`
	ClearPermissions    *bool      `json:"clearPermissions,omitempty"`
	AddUserIDs          []string   `json:"addUserIDs,omitempty"`
	RemoveUserIDs       []string   `json:"removeUserIDs,omitempty"`
	ClearUsers          *bool      `json:"clearUsers,omitempty"`
}
...
type UserRoleConnection struct {
	// A list of edges.
	Edges []*UserRoleEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
