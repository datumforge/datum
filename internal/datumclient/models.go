...
func (Subscribers) IsNode() {}

// A connection to a list of items.
type SubscribersConnection struct {
	// A list of edges.
	Edges []*SubscribersEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
type SubscribersEdge struct {
	// The item at the end of the edge.
	Node *Subscribers `json:"node,omitempty"`
	// A cursor for use in pagination.
	Cursor string `json:"cursor"`
}

// Return response for updateSubscribers mutation
type SubscribersUpdatePayload struct {
	// Updated subscribers
	Subscribers *Subscribers `json:"subscribers"`
}
