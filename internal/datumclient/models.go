...
// CreateTierInput is used for create Tier object.
// Input was generated by ent.
...
type TierConnection struct {
	// A list of edges.
	Edges []*TierEdge `json:"edges,omitempty"`
	// Information to aid in pagination.
	PageInfo *PageInfo `json:"pageInfo"`
	// Identifies the total count of items in the connection.
	TotalCount int64 `json:"totalCount"`
...
// TierWhereInput is used for filtering Tier objects.
// Input was generated by ent.
...
type UpdateOrganizationInput struct {
	...
	AddTierIDs                   []string                        `json:"addTierIDs,omitempty"`
	RemoveTierIDs                []string                        `json:"removeTierIDs,omitempty"`
	ClearTiers                   *bool                           `json:"clearTiers,omitempty"`
...
// UpdateTierInput is used for update Tier object.
// Input was generated by ent.
