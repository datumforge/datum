...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.GroupSettingHistory, c.Integration, c.IntegrationHistory, c.Invite,
		c.OauthProvider, c.OauthProviderHistory, c.OhAuthTooToken, c.OrgMembership,
		...
		c.PersonalAccessToken, c.User, c.UserHistory, c.UserSetting,
		c.UserSettingHistory,
	} {
		n.Use(hooks...)
	}
}
...
type (
	hooks struct {
		...
		PasswordResetToken, PersonalAccessToken, User, UserHistory, UserSetting,
