...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.EmailVerificationToken, c.Entitlement, c.EntitlementHistory, c.Group,
...
type (
	hooks struct {
		EmailVerificationToken, Entitlement, EntitlementHistory, Group, GroupHistory,
		GroupMembership, GroupMembershipHistory, GroupSetting, GroupSettingHistory,
		Integration, IntegrationHistory, OauthProvider, OhAuthTooToken, OrgMembership,
