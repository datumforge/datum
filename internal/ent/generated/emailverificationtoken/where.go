...
func TokenIsNil() predicate.EmailVerificationToken {
	return predicate.EmailVerificationToken(sql.FieldIsNull(FieldToken))
}

// TokenNotNil applies the NotNil predicate on the "token" field.
func TokenNotNil() predicate.EmailVerificationToken {
	return predicate.EmailVerificationToken(sql.FieldNotNull(FieldToken))
}
