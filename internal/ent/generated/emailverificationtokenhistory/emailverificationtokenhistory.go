...
const (
	// Label holds the string label denoting the emailverificationtokenhistory type in the database.
	Label = "email_verification_token_history"
	...
	FieldSecret = "secret"
	// Table holds the table name of the emailverificationtokenhistory in the database.
	Table = "email_verification_token_history"
)

// Columns holds all SQL columns for emailverificationtokenhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldOperation,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("emailverificationtokenhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the EmailVerificationTokenHistory queries.
