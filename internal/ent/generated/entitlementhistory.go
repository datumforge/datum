...
func (*EntitlementHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case entitlementhistory.FieldID, entitlementhistory.FieldOperation, entitlementhistory.FieldRef, entitlementhistory.FieldCreatedBy, entitlementhistory.FieldUpdatedBy, entitlementhistory.FieldDeletedBy, entitlementhistory.FieldTier, entitlementhistory.FieldExternalCustomerID, entitlementhistory.FieldExternalSubscriptionID:
	...
	for i := range columns {
		...
		case entitlementhistory.FieldTier:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				eh.Tier = entitlementhistory.Tier(value.String)
			}
