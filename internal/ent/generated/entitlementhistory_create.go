...
func (ehc *EntitlementHistoryCreate) SetTier(e entitlementhistory.Tier) *EntitlementHistoryCreate {
	ehc.mutation.SetTier(e)
	return ehc
}

// SetNillableTier sets the "tier" field if the given value is not nil.
func (ehc *EntitlementHistoryCreate) SetNillableTier(e *entitlementhistory.Tier) *EntitlementHistoryCreate {
	if e != nil {
		ehc.SetTier(*e)
	}
	return ehc
...
func (ehc *EntitlementHistoryCreate) check() error {
	...
	if _, ok := ehc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "EntitlementHistory.created_at"`)}
	}
	if _, ok := ehc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "EntitlementHistory.updated_at"`)}
	}
	if _, ok := ehc.mutation.Tier(); !ok {
