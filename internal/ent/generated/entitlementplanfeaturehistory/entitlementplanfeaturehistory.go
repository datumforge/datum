...
const (
	// Label holds the string label denoting the entitlementplanfeaturehistory type in the database.
	Label = "entitlement_plan_feature_history"
...
// Columns holds all SQL columns for entitlementplanfeaturehistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldOperation,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("entitlementplanfeaturehistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the EntitlementPlanFeatureHistory queries.
