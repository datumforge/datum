...
const (
	// Label holds the string label denoting the entitlementplanhistory type in the database.
	Label = "entitlement_plan_history"
...
// Columns holds all SQL columns for entitlementplanhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldOperation,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("entitlementplanhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the EntitlementPlanHistory queries.
