...
func (etd *EntityTypeDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(entitytype.Table, sqlgraph.NewFieldSpec(entitytype.FieldID, field.TypeString))
	_spec.Node.Schema = etd.schemaConfig.EntityType
	ctx = internal.NewSchemaConfigContext(ctx, etd.schemaConfig)
