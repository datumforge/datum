...
// SubscriptionWhereInput represents a where input for filtering Subscription queries.
type SubscriptionWhereInput struct {
	Predicates []predicate.Subscription  `json:"-"`
	Not        *SubscriptionWhereInput   `json:"not,omitempty"`
	Or         []*SubscriptionWhereInput `json:"or,omitempty"`
	And        []*SubscriptionWhereInput `json:"and,omitempty"`
...
// AddPredicates adds custom predicates to the where input to be used during the filtering phase.
func (i *SubscriptionWhereInput) AddPredicates(predicates ...predicate.Subscription) {
	i.Predicates = append(i.Predicates, predicates...)
}

// Filter applies the SubscriptionWhereInput filter on the SubscriptionQuery builder.
func (i *SubscriptionWhereInput) Filter(q *SubscriptionQuery) (*SubscriptionQuery, error) {
	if i == nil {
		return q, nil
	}
	p, err := i.P()
	if err != nil {
		if err == ErrEmptySubscriptionWhereInput {
			return q, nil
		}
		return nil, err
	}
...
// ErrEmptySubscriptionWhereInput is returned in case the SubscriptionWhereInput is empty.
var ErrEmptySubscriptionWhereInput = errors.New("generated: empty predicate SubscriptionWhereInput")

// P returns a predicate for filtering subscriptions.
// An error is returned if the input is empty or invalid.
func (i *SubscriptionWhereInput) P() (predicate.Subscription, error) {
	...
	if i.IDEqualFold != nil {
		predicates = append(predicates, subscription.IDEqualFold(*i.IDEqualFold))
	}
	if i.IDContainsFold != nil {
		predicates = append(predicates, subscription.IDContainsFold(*i.IDContainsFold))
	}
	if i.Tier != nil {
	...
	if i.ExpiresAt != nil {
		predicates = append(predicates, subscription.ExpiresAtEQ(*i.ExpiresAt))
	}
	if i.ExpiresAtNEQ != nil {
		predicates = append(predicates, subscription.ExpiresAtNEQ(*i.ExpiresAtNEQ))
	}
	if len(i.ExpiresAtIn) > 0 {
		predicates = append(predicates, subscription.ExpiresAtIn(i.ExpiresAtIn...))
	}
	if len(i.ExpiresAtNotIn) > 0 {
		predicates = append(predicates, subscription.ExpiresAtNotIn(i.ExpiresAtNotIn...))
	}
	if i.ExpiresAtGT != nil {
		predicates = append(predicates, subscription.ExpiresAtGT(*i.ExpiresAtGT))
	}
	if i.ExpiresAtGTE != nil {
		predicates = append(predicates, subscription.ExpiresAtGTE(*i.ExpiresAtGTE))
	}
	if i.ExpiresAtLT != nil {
		predicates = append(predicates, subscription.ExpiresAtLT(*i.ExpiresAtLT))
	}
	if i.ExpiresAtLTE != nil {
		predicates = append(predicates, subscription.ExpiresAtLTE(*i.ExpiresAtLTE))
	}
	if i.ExpiresAtIsNil {
		predicates = append(predicates, subscription.ExpiresAtIsNil())
	}
	if i.ExpiresAtNotNil {
		predicates = append(predicates, subscription.ExpiresAtNotNil())
	}
	if i.Cancelled != nil {
		predicates = append(predicates, subscription.CancelledEQ(*i.Cancelled))
	}
	if i.CancelledNEQ != nil {
		predicates = append(predicates, subscription.CancelledNEQ(*i.CancelledNEQ))
	}

	switch len(predicates) {
	case 0:
		return nil, ErrEmptySubscriptionWhereInput
	case 1:
		return predicates[0], nil
	default:
