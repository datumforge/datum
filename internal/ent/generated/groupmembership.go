...
func (*GroupMembership) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case groupmembership.FieldID, groupmembership.FieldCreatedBy, groupmembership.FieldUpdatedBy, groupmembership.FieldUserID, groupmembership.FieldGroupID:
			values[i] = new(sql.NullString)
		case groupmembership.FieldCreatedAt, groupmembership.FieldUpdatedAt, groupmembership.FieldJoinedAt:
...
func (gm *GroupMembership) String() string {
	...
	builder.WriteString(gm.JoinedAt.Format(time.ANSIC))
	builder.WriteString(", ")
