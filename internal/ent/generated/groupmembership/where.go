...
func GroupRoleEQ(v enums.Role) predicate.GroupMembership {
	vc := v
	return predicate.GroupMembership(sql.FieldEQ(FieldGroupRole, vc))
}

// GroupRoleNEQ applies the NEQ predicate on the "group_role" field.
func GroupRoleNEQ(v enums.Role) predicate.GroupMembership {
	vc := v
	return predicate.GroupMembership(sql.FieldNEQ(FieldGroupRole, vc))
}

// GroupRoleIn applies the In predicate on the "group_role" field.
func GroupRoleIn(vs ...enums.Role) predicate.GroupMembership {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.GroupMembership(sql.FieldIn(FieldGroupRole, v...))
}

// GroupRoleNotIn applies the NotIn predicate on the "group_role" field.
func GroupRoleNotIn(vs ...enums.Role) predicate.GroupMembership {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.GroupMembership(sql.FieldNotIn(FieldGroupRole, v...))
}
...
func HasRole() predicate.GroupMembership {
	return predicate.GroupMembership(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasRoleWith(preds ...predicate.Role) predicate.GroupMembership {
	return predicate.GroupMembership(func(s *sql.Selector) {
		step := newRoleStep()
		schemaConfig := internal.SchemaConfigFromContext(s.Context())
		step.To.Schema = schemaConfig.Role
