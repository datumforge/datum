...
func (gmu *GroupMembershipUpdate) SetGroupRole(e enums.Role) *GroupMembershipUpdate {
	gmu.mutation.SetGroupRole(e)
	return gmu
}

// SetNillableGroupRole sets the "group_role" field if the given value is not nil.
func (gmu *GroupMembershipUpdate) SetNillableGroupRole(e *enums.Role) *GroupMembershipUpdate {
	if e != nil {
		gmu.SetGroupRole(*e)
	}
	return gmu
...
func (gmu *GroupMembershipUpdate) SetGroupID(id string) *GroupMembershipUpdate {
...
func (gmu *GroupMembershipUpdate) SetUserID(id string) *GroupMembershipUpdate {
...
func (gmu *GroupMembershipUpdate) SetRoleID(id string) *GroupMembershipUpdate {
	gmu.mutation.SetRoleID(id)
	return gmu
}

// SetNillableRoleID sets the "role" edge to the Role entity by ID if the given value is not nil.
func (gmu *GroupMembershipUpdate) SetNillableRoleID(id *string) *GroupMembershipUpdate {
	if id != nil {
		gmu = gmu.SetRoleID(*id)
	}
	return gmu
}

// SetRole sets the "role" edge to the Role entity.
func (gmu *GroupMembershipUpdate) SetRole(r *Role) *GroupMembershipUpdate {
	return gmu.SetRoleID(r.ID)
}
...
func (gmu *GroupMembershipUpdate) ClearRole() *GroupMembershipUpdate {
	gmu.mutation.ClearRole()
	return gmu
}
...
func (gmu *GroupMembershipUpdate) check() error {
	if v, ok := gmu.mutation.GroupRole(); ok {
...
func (gmu *GroupMembershipUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := gmu.mutation.GroupRole(); ok {
	...
	if nodes := gmu.mutation.RoleIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   groupmembership.RoleTable,
...
// SetGroupRole sets the "group_role" field.
func (gmuo *GroupMembershipUpdateOne) SetGroupRole(e enums.Role) *GroupMembershipUpdateOne {
	gmuo.mutation.SetGroupRole(e)
	return gmuo
}

// SetNillableGroupRole sets the "group_role" field if the given value is not nil.
func (gmuo *GroupMembershipUpdateOne) SetNillableGroupRole(e *enums.Role) *GroupMembershipUpdateOne {
	if e != nil {
		gmuo.SetGroupRole(*e)
	}
	return gmuo
...
// SetGroupID sets the "group" edge to the Group entity by ID.
func (gmuo *GroupMembershipUpdateOne) SetGroupID(id string) *GroupMembershipUpdateOne {
...
// SetUserID sets the "user" edge to the User entity by ID.
func (gmuo *GroupMembershipUpdateOne) SetUserID(id string) *GroupMembershipUpdateOne {
...
// SetRoleID sets the "role" edge to the Role entity by ID.
func (gmuo *GroupMembershipUpdateOne) SetRoleID(id string) *GroupMembershipUpdateOne {
	gmuo.mutation.SetRoleID(id)
	return gmuo
}

// SetNillableRoleID sets the "role" edge to the Role entity by ID if the given value is not nil.
func (gmuo *GroupMembershipUpdateOne) SetNillableRoleID(id *string) *GroupMembershipUpdateOne {
	if id != nil {
		gmuo = gmuo.SetRoleID(*id)
	}
	return gmuo
}

// SetRole sets the "role" edge to the Role entity.
func (gmuo *GroupMembershipUpdateOne) SetRole(r *Role) *GroupMembershipUpdateOne {
	return gmuo.SetRoleID(r.ID)
}
...
// ClearRole clears the "role" edge to the Role entity.
func (gmuo *GroupMembershipUpdateOne) ClearRole() *GroupMembershipUpdateOne {
	gmuo.mutation.ClearRole()
	return gmuo
}
...
func (gmuo *GroupMembershipUpdateOne) check() error {
	if v, ok := gmuo.mutation.GroupRole(); ok {
		if err := groupmembership.GroupRoleValidator(v); err != nil {
			return &ValidationError{Name: "group_role", err: fmt.Errorf(`generated: validator failed for field "GroupMembership.group_role": %w`, err)}
		}
	}
...
func (gmuo *GroupMembershipUpdateOne) sqlSave(ctx context.Context) (_node *GroupMembership, err error) {
	...
	if value, ok := gmuo.mutation.GroupRole(); ok {
		_spec.SetField(groupmembership.FieldGroupRole, field.TypeEnum, value)
	}
	...
	if nodes := gmuo.mutation.RoleIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   groupmembership.RoleTable,
