...
const (
	// Label holds the string label denoting the groupmembershiphistory type in the database.
	Label = "group_membership_history"
	...
	FieldUserID = "user_id"
	// Table holds the table name of the groupmembershiphistory in the database.
	Table = "group_membership_history"
)

// Columns holds all SQL columns for groupmembershiphistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldOperation,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("groupmembershiphistory: invalid enum value for operation field: %q", o)
	}
}
...
func RoleValidator(r enums.Role) error {
	...
	case "ADMIN", "MEMBER":
		return nil
	default:
		return fmt.Errorf("groupmembershiphistory: invalid enum value for role field: %q", r)
	}
}

// OrderOption defines the ordering options for the GroupMembershipHistory queries.
