...
type GroupSettingHistory struct {
	...
	JoinPolicy groupsettinghistory.JoinPolicy `json:"join_policy,omitempty"`
...
func (*GroupSettingHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case groupsettinghistory.FieldID, groupsettinghistory.FieldOperation, groupsettinghistory.FieldRef, groupsettinghistory.FieldCreatedBy, groupsettinghistory.FieldUpdatedBy, groupsettinghistory.FieldDeletedBy, groupsettinghistory.FieldVisibility, groupsettinghistory.FieldJoinPolicy:
	...
	for i := range columns {
		...
		case groupsettinghistory.FieldOperation:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				gsh.Operation = enthistory.OpType(value.String)
			}
		...
		case groupsettinghistory.FieldVisibility:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				gsh.Visibility = groupsettinghistory.Visibility(value.String)
			}
		case groupsettinghistory.FieldJoinPolicy:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field join_policy", values[i])
			} else if value.Valid {
				gsh.JoinPolicy = groupsettinghistory.JoinPolicy(value.String)
			}
		case groupsettinghistory.FieldTags:
