...
func VisibilityEQ(v Visibility) predicate.GroupSettingHistory {
	return predicate.GroupSettingHistory(sql.FieldEQ(FieldVisibility, v))
}

// VisibilityNEQ applies the NEQ predicate on the "visibility" field.
func VisibilityNEQ(v Visibility) predicate.GroupSettingHistory {
	return predicate.GroupSettingHistory(sql.FieldNEQ(FieldVisibility, v))
}

// VisibilityIn applies the In predicate on the "visibility" field.
func VisibilityIn(vs ...Visibility) predicate.GroupSettingHistory {
	return predicate.GroupSettingHistory(sql.FieldIn(FieldVisibility, vs...))
}

// VisibilityNotIn applies the NotIn predicate on the "visibility" field.
func VisibilityNotIn(vs ...Visibility) predicate.GroupSettingHistory {
	return predicate.GroupSettingHistory(sql.FieldNotIn(FieldVisibility, vs...))
}

// JoinPolicyEQ applies the EQ predicate on the "join_policy" field.
func JoinPolicyEQ(v JoinPolicy) predicate.GroupSettingHistory {
	return predicate.GroupSettingHistory(sql.FieldEQ(FieldJoinPolicy, v))
}

// JoinPolicyNEQ applies the NEQ predicate on the "join_policy" field.
func JoinPolicyNEQ(v JoinPolicy) predicate.GroupSettingHistory {
	return predicate.GroupSettingHistory(sql.FieldNEQ(FieldJoinPolicy, v))
}

// JoinPolicyIn applies the In predicate on the "join_policy" field.
func JoinPolicyIn(vs ...JoinPolicy) predicate.GroupSettingHistory {
	return predicate.GroupSettingHistory(sql.FieldIn(FieldJoinPolicy, vs...))
}

// JoinPolicyNotIn applies the NotIn predicate on the "join_policy" field.
func JoinPolicyNotIn(vs ...JoinPolicy) predicate.GroupSettingHistory {
	return predicate.GroupSettingHistory(sql.FieldNotIn(FieldJoinPolicy, vs...))
}
