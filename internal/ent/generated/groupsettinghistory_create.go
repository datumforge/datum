...
func (gshc *GroupSettingHistoryCreate) SetVisibility(gr groupsettinghistory.Visibility) *GroupSettingHistoryCreate {
	gshc.mutation.SetVisibility(gr)
	return gshc
}

// SetNillableVisibility sets the "visibility" field if the given value is not nil.
func (gshc *GroupSettingHistoryCreate) SetNillableVisibility(gr *groupsettinghistory.Visibility) *GroupSettingHistoryCreate {
	if gr != nil {
		gshc.SetVisibility(*gr)
	}
	return gshc
}

// SetJoinPolicy sets the "join_policy" field.
func (gshc *GroupSettingHistoryCreate) SetJoinPolicy(gp groupsettinghistory.JoinPolicy) *GroupSettingHistoryCreate {
	gshc.mutation.SetJoinPolicy(gp)
	return gshc
}

// SetNillableJoinPolicy sets the "join_policy" field if the given value is not nil.
func (gshc *GroupSettingHistoryCreate) SetNillableJoinPolicy(gp *groupsettinghistory.JoinPolicy) *GroupSettingHistoryCreate {
	if gp != nil {
		gshc.SetJoinPolicy(*gp)
	}
	return gshc
}
...
func (gshc *GroupSettingHistoryCreate) check() error {
	...
	if _, ok := gshc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "GroupSettingHistory.created_at"`)}
	}
	if _, ok := gshc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "GroupSettingHistory.updated_at"`)}
	}
	if _, ok := gshc.mutation.Visibility(); !ok {
	...
	if _, ok := gshc.mutation.Tags(); !ok {
		return &ValidationError{Name: "tags", err: errors.New(`generated: missing required field "GroupSettingHistory.tags"`)}
	}
	if _, ok := gshc.mutation.SyncToSlack(); !ok {
		return &ValidationError{Name: "sync_to_slack", err: errors.New(`generated: missing required field "GroupSettingHistory.sync_to_slack"`)}
	}
	if _, ok := gshc.mutation.SyncToGithub(); !ok {
		return &ValidationError{Name: "sync_to_github", err: errors.New(`generated: missing required field "GroupSettingHistory.sync_to_github"`)}
	}
	return nil
}
