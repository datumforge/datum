...
func (gshu *GroupSettingHistoryUpdate) SetVisibility(gr groupsettinghistory.Visibility) *GroupSettingHistoryUpdate {
	gshu.mutation.SetVisibility(gr)
	return gshu
}

// SetNillableVisibility sets the "visibility" field if the given value is not nil.
func (gshu *GroupSettingHistoryUpdate) SetNillableVisibility(gr *groupsettinghistory.Visibility) *GroupSettingHistoryUpdate {
	if gr != nil {
		gshu.SetVisibility(*gr)
	}
	return gshu
}

// SetJoinPolicy sets the "join_policy" field.
func (gshu *GroupSettingHistoryUpdate) SetJoinPolicy(gp groupsettinghistory.JoinPolicy) *GroupSettingHistoryUpdate {
	gshu.mutation.SetJoinPolicy(gp)
	return gshu
}

// SetNillableJoinPolicy sets the "join_policy" field if the given value is not nil.
func (gshu *GroupSettingHistoryUpdate) SetNillableJoinPolicy(gp *groupsettinghistory.JoinPolicy) *GroupSettingHistoryUpdate {
	if gp != nil {
		gshu.SetJoinPolicy(*gp)
	}
	return gshu
}
...
func (gshu *GroupSettingHistoryUpdate) defaults() {
	if _, ok := gshu.mutation.UpdatedAt(); !ok {
...
// SetVisibility sets the "visibility" field.
func (gshuo *GroupSettingHistoryUpdateOne) SetVisibility(gr groupsettinghistory.Visibility) *GroupSettingHistoryUpdateOne {
	gshuo.mutation.SetVisibility(gr)
	return gshuo
}

// SetNillableVisibility sets the "visibility" field if the given value is not nil.
func (gshuo *GroupSettingHistoryUpdateOne) SetNillableVisibility(gr *groupsettinghistory.Visibility) *GroupSettingHistoryUpdateOne {
	if gr != nil {
		gshuo.SetVisibility(*gr)
	}
	return gshuo
}

// SetJoinPolicy sets the "join_policy" field.
func (gshuo *GroupSettingHistoryUpdateOne) SetJoinPolicy(gp groupsettinghistory.JoinPolicy) *GroupSettingHistoryUpdateOne {
	gshuo.mutation.SetJoinPolicy(gp)
	return gshuo
}

// SetNillableJoinPolicy sets the "join_policy" field if the given value is not nil.
func (gshuo *GroupSettingHistoryUpdateOne) SetNillableJoinPolicy(gp *groupsettinghistory.JoinPolicy) *GroupSettingHistoryUpdateOne {
	if gp != nil {
		gshuo.SetJoinPolicy(*gp)
	}
	return gshuo
}
...
func (gshuo *GroupSettingHistoryUpdateOne) defaults() {
	if _, ok := gshuo.mutation.UpdatedAt(); !ok {
		v := groupsettinghistory.UpdateDefaultUpdatedAt()
