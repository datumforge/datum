...
func (*IntegrationHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case integrationhistory.FieldID, integrationhistory.FieldOperation, integrationhistory.FieldRef, integrationhistory.FieldCreatedBy, integrationhistory.FieldUpdatedBy, integrationhistory.FieldDeletedBy, integrationhistory.FieldName, integrationhistory.FieldDescription, integrationhistory.FieldKind, integrationhistory.FieldSecretName:
	...
	for i := range columns {
		...
		case integrationhistory.FieldOperation:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				ih.Operation = enthistory.OpType(value.String)
			}
