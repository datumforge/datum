...
type RoleUserFunc func(context.Context, *generated.RoleUserQuery) (generated.Value, error)

// Query calls f(ctx, q).
func (f RoleUserFunc) Query(ctx context.Context, q generated.Query) (generated.Value, error) {
	if q, ok := q.(*generated.RoleUserQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *generated.RoleUserQuery", q)
}

// The TraverseRoleUser type is an adapter to allow the use of ordinary function as Traverser.
type TraverseRoleUser func(context.Context, *generated.RoleUserQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseRoleUser) Intercept(next generated.Querier) generated.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseRoleUser) Traverse(ctx context.Context, q generated.Query) error {
	if q, ok := q.(*generated.RoleUserQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *generated.RoleUserQuery", q)
}
...
func NewQuery(q generated.Query) (Query, error) {
	...
	case *generated.RoleUserQuery:
		return &query[*generated.RoleUserQuery, predicate.RoleUser, roleuser.OrderOption]{typ: generated.TypeRoleUser, tq: q}, nil
