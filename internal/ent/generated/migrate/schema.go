...
var (
	...
	WebauthnsColumns = []*schema.Column{
		...
		{Name: "credential_id", Type: field.TypeString, Unique: true, Nullable: true},
		...
		{Name: "sign_count", Type: field.TypeInt, Nullable: true},
		{Name: "transports", Type: field.TypeJSON, Nullable: true},
		{Name: "flags", Type: field.TypeJSON, Nullable: true},
		{Name: "authenticator", Type: field.TypeJSON, Nullable: true},
