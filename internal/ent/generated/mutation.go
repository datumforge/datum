...
func (m *EmailVerificationTokenMutation) ClearToken() {
	m.token = nil
	m.clearedFields[emailverificationtoken.FieldToken] = struct{}{}
}

// TokenCleared returns if the "token" field was cleared in this mutation.
func (m *EmailVerificationTokenMutation) TokenCleared() bool {
	_, ok := m.clearedFields[emailverificationtoken.FieldToken]
	return ok
}
...
func (m *EmailVerificationTokenMutation) ResetToken() {
	m.token = nil
	delete(m.clearedFields, emailverificationtoken.FieldToken)
}
...
func (m *UserMutation) SetEmailVerificationTokensID(id string) {
	m.email_verification_tokens = &id
}
...
// EmailVerificationTokensID returns the "email_verification_tokens" edge ID in the mutation.
func (m *UserMutation) EmailVerificationTokensID() (id string, exists bool) {
	if m.email_verification_tokens != nil {
		return *m.email_verification_tokens, true
	}
	return
}
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// EmailVerificationTokensID instead. It exists only for internal usage by the builders.
