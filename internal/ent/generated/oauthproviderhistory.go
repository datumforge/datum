	...
	for i := range columns {
		...
		case oauthproviderhistory.FieldOperation:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				oph.Operation = enthistory.OpType(value.String)
			}
