...
func AuthStyle(v uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldEQ(FieldAuthStyle, v))
}
...
func AuthStyleEQ(v uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldEQ(FieldAuthStyle, v))
}

// AuthStyleNEQ applies the NEQ predicate on the "auth_style" field.
func AuthStyleNEQ(v uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldNEQ(FieldAuthStyle, v))
}

// AuthStyleIn applies the In predicate on the "auth_style" field.
func AuthStyleIn(vs ...uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldIn(FieldAuthStyle, vs...))
}

// AuthStyleNotIn applies the NotIn predicate on the "auth_style" field.
func AuthStyleNotIn(vs ...uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldNotIn(FieldAuthStyle, vs...))
}

// AuthStyleGT applies the GT predicate on the "auth_style" field.
func AuthStyleGT(v uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldGT(FieldAuthStyle, v))
}

// AuthStyleGTE applies the GTE predicate on the "auth_style" field.
func AuthStyleGTE(v uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldGTE(FieldAuthStyle, v))
}

// AuthStyleLT applies the LT predicate on the "auth_style" field.
func AuthStyleLT(v uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldLT(FieldAuthStyle, v))
}

// AuthStyleLTE applies the LTE predicate on the "auth_style" field.
func AuthStyleLTE(v uint8) predicate.OauthProviderHistory {
	return predicate.OauthProviderHistory(sql.FieldLTE(FieldAuthStyle, v))
}
