...
func (ophc *OauthProviderHistoryCreate) SetAuthStyle(u uint8) *OauthProviderHistoryCreate {
	ophc.mutation.SetAuthStyle(u)
	return ophc
}
...
func (ophc *OauthProviderHistoryCreate) check() error {
	...
	if _, ok := ophc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "OauthProviderHistory.created_at"`)}
	}
	if _, ok := ophc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "OauthProviderHistory.updated_at"`)}
	}
