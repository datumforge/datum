...
func (ophu *OauthProviderHistoryUpdate) defaults() {
	if _, ok := ophu.mutation.UpdatedAt(); !ok {
...
// defaults sets the default values of the builder before save.
func (ophuo *OauthProviderHistoryUpdateOne) defaults() {
	if _, ok := ophuo.mutation.UpdatedAt(); !ok {
		v := oauthproviderhistory.UpdateDefaultUpdatedAt()
