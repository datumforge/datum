...
const (
	// Label holds the string label denoting the ohauthtootokenhistory type in the database.
	Label = "oh_auth_too_token_history"
	...
	// Table holds the table name of the ohauthtootokenhistory in the database.
	Table = "oh_auth_too_token_history"
)

// Columns holds all SQL columns for ohauthtootokenhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldOperation,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("ohauthtootokenhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the OhAuthTooTokenHistory queries.
