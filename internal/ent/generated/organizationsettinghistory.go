...
func (*OrganizationSettingHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case organizationsettinghistory.FieldDomains, organizationsettinghistory.FieldTags:
			values[i] = new([]byte)
		case organizationsettinghistory.FieldID, organizationsettinghistory.FieldOperation, organizationsettinghistory.FieldRef, organizationsettinghistory.FieldCreatedBy, organizationsettinghistory.FieldUpdatedBy, organizationsettinghistory.FieldDeletedBy, organizationsettinghistory.FieldSSOCert, organizationsettinghistory.FieldSSOEntrypoint, organizationsettinghistory.FieldSSOIssuer, organizationsettinghistory.FieldBillingContact, organizationsettinghistory.FieldBillingEmail, organizationsettinghistory.FieldBillingPhone, organizationsettinghistory.FieldBillingAddress, organizationsettinghistory.FieldTaxIdentifier:
	...
	for i := range columns {
		...
		case organizationsettinghistory.FieldOperation:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				osh.Operation = enthistory.OpType(value.String)
			}
...
func (osh *OrganizationSettingHistory) String() string {
	...
	builder.WriteString(osh.SSOCert)
	builder.WriteString(", ")
	builder.WriteString("sso_entrypoint=")
	builder.WriteString(osh.SSOEntrypoint)
	builder.WriteString(", ")
	builder.WriteString("sso_issuer=")
	builder.WriteString(osh.SSOIssuer)
	builder.WriteString(", ")
