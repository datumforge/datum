...
func (oshc *OrganizationSettingHistoryCreate) SetSSOCert(s string) *OrganizationSettingHistoryCreate {
	oshc.mutation.SetSSOCert(s)
	return oshc
}

// SetNillableSSOCert sets the "sso_cert" field if the given value is not nil.
func (oshc *OrganizationSettingHistoryCreate) SetNillableSSOCert(s *string) *OrganizationSettingHistoryCreate {
	if s != nil {
		oshc.SetSSOCert(*s)
	}
	return oshc
...
func (oshc *OrganizationSettingHistoryCreate) SetSSOEntrypoint(s string) *OrganizationSettingHistoryCreate {
	oshc.mutation.SetSSOEntrypoint(s)
	return oshc
}

// SetNillableSSOEntrypoint sets the "sso_entrypoint" field if the given value is not nil.
func (oshc *OrganizationSettingHistoryCreate) SetNillableSSOEntrypoint(s *string) *OrganizationSettingHistoryCreate {
	if s != nil {
		oshc.SetSSOEntrypoint(*s)
	}
	return oshc
}

// SetSSOIssuer sets the "sso_issuer" field.
func (oshc *OrganizationSettingHistoryCreate) SetSSOIssuer(s string) *OrganizationSettingHistoryCreate {
	oshc.mutation.SetSSOIssuer(s)
	return oshc
}

// SetNillableSSOIssuer sets the "sso_issuer" field if the given value is not nil.
func (oshc *OrganizationSettingHistoryCreate) SetNillableSSOIssuer(s *string) *OrganizationSettingHistoryCreate {
	if s != nil {
		oshc.SetSSOIssuer(*s)
	}
	return oshc
...
func (oshc *OrganizationSettingHistoryCreate) check() error {
	...
	if _, ok := oshc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "OrganizationSettingHistory.created_at"`)}
	}
	if _, ok := oshc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "OrganizationSettingHistory.updated_at"`)}
	}
	return nil
}
