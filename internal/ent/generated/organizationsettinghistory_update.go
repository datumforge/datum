...
func (oshu *OrganizationSettingHistoryUpdate) SetSSOCert(s string) *OrganizationSettingHistoryUpdate {
	oshu.mutation.SetSSOCert(s)
	return oshu
}

// SetNillableSSOCert sets the "sso_cert" field if the given value is not nil.
func (oshu *OrganizationSettingHistoryUpdate) SetNillableSSOCert(s *string) *OrganizationSettingHistoryUpdate {
	if s != nil {
		oshu.SetSSOCert(*s)
	}
	return oshu
...
func (oshu *OrganizationSettingHistoryUpdate) ClearSSOCert() *OrganizationSettingHistoryUpdate {
	oshu.mutation.ClearSSOCert()
	return oshu
}

// SetSSOEntrypoint sets the "sso_entrypoint" field.
func (oshu *OrganizationSettingHistoryUpdate) SetSSOEntrypoint(s string) *OrganizationSettingHistoryUpdate {
	oshu.mutation.SetSSOEntrypoint(s)
	return oshu
}

// SetNillableSSOEntrypoint sets the "sso_entrypoint" field if the given value is not nil.
func (oshu *OrganizationSettingHistoryUpdate) SetNillableSSOEntrypoint(s *string) *OrganizationSettingHistoryUpdate {
	if s != nil {
		oshu.SetSSOEntrypoint(*s)
	}
	return oshu
}

// ClearSSOEntrypoint clears the value of the "sso_entrypoint" field.
func (oshu *OrganizationSettingHistoryUpdate) ClearSSOEntrypoint() *OrganizationSettingHistoryUpdate {
	oshu.mutation.ClearSSOEntrypoint()
	return oshu
}

// SetSSOIssuer sets the "sso_issuer" field.
func (oshu *OrganizationSettingHistoryUpdate) SetSSOIssuer(s string) *OrganizationSettingHistoryUpdate {
	oshu.mutation.SetSSOIssuer(s)
	return oshu
}

// SetNillableSSOIssuer sets the "sso_issuer" field if the given value is not nil.
func (oshu *OrganizationSettingHistoryUpdate) SetNillableSSOIssuer(s *string) *OrganizationSettingHistoryUpdate {
	if s != nil {
		oshu.SetSSOIssuer(*s)
	}
	return oshu
...
func (oshu *OrganizationSettingHistoryUpdate) ClearSSOIssuer() *OrganizationSettingHistoryUpdate {
	oshu.mutation.ClearSSOIssuer()
	return oshu
}
...
func (oshu *OrganizationSettingHistoryUpdate) defaults() {
	if _, ok := oshu.mutation.UpdatedAt(); !ok {
...
func (oshu *OrganizationSettingHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := oshu.mutation.SSOCert(); ok {
		_spec.SetField(organizationsettinghistory.FieldSSOCert, field.TypeString, value)
	}
	if oshu.mutation.SSOCertCleared() {
		_spec.ClearField(organizationsettinghistory.FieldSSOCert, field.TypeString)
	}
	if value, ok := oshu.mutation.SSOEntrypoint(); ok {
		_spec.SetField(organizationsettinghistory.FieldSSOEntrypoint, field.TypeString, value)
	}
	if oshu.mutation.SSOEntrypointCleared() {
		_spec.ClearField(organizationsettinghistory.FieldSSOEntrypoint, field.TypeString)
	}
	if value, ok := oshu.mutation.SSOIssuer(); ok {
		_spec.SetField(organizationsettinghistory.FieldSSOIssuer, field.TypeString, value)
	}
	if oshu.mutation.SSOIssuerCleared() {
		_spec.ClearField(organizationsettinghistory.FieldSSOIssuer, field.TypeString)
	}
...
// SetSSOCert sets the "sso_cert" field.
func (oshuo *OrganizationSettingHistoryUpdateOne) SetSSOCert(s string) *OrganizationSettingHistoryUpdateOne {
	oshuo.mutation.SetSSOCert(s)
	return oshuo
}

// SetNillableSSOCert sets the "sso_cert" field if the given value is not nil.
func (oshuo *OrganizationSettingHistoryUpdateOne) SetNillableSSOCert(s *string) *OrganizationSettingHistoryUpdateOne {
	if s != nil {
		oshuo.SetSSOCert(*s)
	}
	return oshuo
...
// ClearSSOCert clears the value of the "sso_cert" field.
func (oshuo *OrganizationSettingHistoryUpdateOne) ClearSSOCert() *OrganizationSettingHistoryUpdateOne {
	oshuo.mutation.ClearSSOCert()
	return oshuo
}

// SetSSOEntrypoint sets the "sso_entrypoint" field.
func (oshuo *OrganizationSettingHistoryUpdateOne) SetSSOEntrypoint(s string) *OrganizationSettingHistoryUpdateOne {
	oshuo.mutation.SetSSOEntrypoint(s)
	return oshuo
}

// SetNillableSSOEntrypoint sets the "sso_entrypoint" field if the given value is not nil.
func (oshuo *OrganizationSettingHistoryUpdateOne) SetNillableSSOEntrypoint(s *string) *OrganizationSettingHistoryUpdateOne {
	if s != nil {
		oshuo.SetSSOEntrypoint(*s)
	}
	return oshuo
}

// ClearSSOEntrypoint clears the value of the "sso_entrypoint" field.
func (oshuo *OrganizationSettingHistoryUpdateOne) ClearSSOEntrypoint() *OrganizationSettingHistoryUpdateOne {
	oshuo.mutation.ClearSSOEntrypoint()
	return oshuo
}

// SetSSOIssuer sets the "sso_issuer" field.
func (oshuo *OrganizationSettingHistoryUpdateOne) SetSSOIssuer(s string) *OrganizationSettingHistoryUpdateOne {
	oshuo.mutation.SetSSOIssuer(s)
	return oshuo
}

// SetNillableSSOIssuer sets the "sso_issuer" field if the given value is not nil.
func (oshuo *OrganizationSettingHistoryUpdateOne) SetNillableSSOIssuer(s *string) *OrganizationSettingHistoryUpdateOne {
	if s != nil {
		oshuo.SetSSOIssuer(*s)
	}
	return oshuo
}

// ClearSSOIssuer clears the value of the "sso_issuer" field.
func (oshuo *OrganizationSettingHistoryUpdateOne) ClearSSOIssuer() *OrganizationSettingHistoryUpdateOne {
	oshuo.mutation.ClearSSOIssuer()
	return oshuo
}
...
func (oshuo *OrganizationSettingHistoryUpdateOne) defaults() {
	if _, ok := oshuo.mutation.UpdatedAt(); !ok {
		v := organizationsettinghistory.UpdateDefaultUpdatedAt()
...
func (oshuo *OrganizationSettingHistoryUpdateOne) sqlSave(ctx context.Context) (_node *OrganizationSettingHistory, err error) {
	...
	if value, ok := oshuo.mutation.SSOCert(); ok {
		_spec.SetField(organizationsettinghistory.FieldSSOCert, field.TypeString, value)
	}
	if oshuo.mutation.SSOCertCleared() {
		_spec.ClearField(organizationsettinghistory.FieldSSOCert, field.TypeString)
	}
	if value, ok := oshuo.mutation.SSOEntrypoint(); ok {
		_spec.SetField(organizationsettinghistory.FieldSSOEntrypoint, field.TypeString, value)
	}
	if oshuo.mutation.SSOEntrypointCleared() {
		_spec.ClearField(organizationsettinghistory.FieldSSOEntrypoint, field.TypeString)
	}
	if value, ok := oshuo.mutation.SSOIssuer(); ok {
		_spec.SetField(organizationsettinghistory.FieldSSOIssuer, field.TypeString, value)
	}
	if oshuo.mutation.SSOIssuerCleared() {
		_spec.ClearField(organizationsettinghistory.FieldSSOIssuer, field.TypeString)
	}
