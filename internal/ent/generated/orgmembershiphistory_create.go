...
func (omhc *OrgMembershipHistoryCreate) SetOrgID(s string) *OrgMembershipHistoryCreate {
	omhc.mutation.SetOrgID(s)
	return omhc
}
...
func (omhc *OrgMembershipHistoryCreate) check() error {
	...
	if _, ok := omhc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`generated: missing required field "OrgMembershipHistory.created_at"`)}
	}
	if _, ok := omhc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`generated: missing required field "OrgMembershipHistory.updated_at"`)}
	}
	if _, ok := omhc.mutation.Role(); !ok {
	...
	if _, ok := omhc.mutation.OrgID(); !ok {
		return &ValidationError{Name: "org_id", err: errors.New(`generated: missing required field "OrgMembershipHistory.org_id"`)}
	}
...
func (omhc *OrgMembershipHistoryCreate) createSpec() (*OrgMembershipHistory, *sqlgraph.CreateSpec) {
	...
	if value, ok := omhc.mutation.OrgID(); ok {
		_spec.SetField(orgmembershiphistory.FieldOrgID, field.TypeString, value)
		_node.OrgID = value
	}
