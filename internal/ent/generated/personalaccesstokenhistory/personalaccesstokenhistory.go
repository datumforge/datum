...
const (
	// Label holds the string label denoting the personalaccesstokenhistory type in the database.
	Label = "personal_access_token_history"
	...
	// Table holds the table name of the personalaccesstokenhistory in the database.
	Table = "personal_access_token_history"
)

// Columns holds all SQL columns for personalaccesstokenhistory fields.
var Columns = []string{
	FieldID,
	FieldHistoryTime,
	FieldOperation,
...
func OperationValidator(o enthistory.OpType) error {
	...
	case "INSERT", "UPDATE", "DELETE":
		return nil
	default:
		return fmt.Errorf("personalaccesstokenhistory: invalid enum value for operation field: %q", o)
	}
}

// OrderOption defines the ordering options for the PersonalAccessTokenHistory queries.
