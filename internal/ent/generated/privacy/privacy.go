...
// The EmailVerificationTokenHistoryQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type EmailVerificationTokenHistoryQueryRuleFunc func(context.Context, *generated.EmailVerificationTokenHistoryQuery) error

// EvalQuery return f(ctx, q).
func (f EmailVerificationTokenHistoryQueryRuleFunc) EvalQuery(ctx context.Context, q generated.Query) error {
	if q, ok := q.(*generated.EmailVerificationTokenHistoryQuery); ok {
		return f(ctx, q)
	}
	return Denyf("generated/privacy: unexpected query type %T, expect *generated.EmailVerificationTokenHistoryQuery", q)
}

// The EmailVerificationTokenHistoryMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type EmailVerificationTokenHistoryMutationRuleFunc func(context.Context, *generated.EmailVerificationTokenHistoryMutation) error

// EvalMutation calls f(ctx, m).
func (f EmailVerificationTokenHistoryMutationRuleFunc) EvalMutation(ctx context.Context, m generated.Mutation) error {
	if m, ok := m.(*generated.EmailVerificationTokenHistoryMutation); ok {
		return f(ctx, m)
	}
	return Denyf("generated/privacy: unexpected mutation type %T, expect *generated.EmailVerificationTokenHistoryMutation", m)
}
...
// The OhAuthTooTokenHistoryQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type OhAuthTooTokenHistoryQueryRuleFunc func(context.Context, *generated.OhAuthTooTokenHistoryQuery) error

// EvalQuery return f(ctx, q).
func (f OhAuthTooTokenHistoryQueryRuleFunc) EvalQuery(ctx context.Context, q generated.Query) error {
	if q, ok := q.(*generated.OhAuthTooTokenHistoryQuery); ok {
		return f(ctx, q)
	}
	return Denyf("generated/privacy: unexpected query type %T, expect *generated.OhAuthTooTokenHistoryQuery", q)
}

// The OhAuthTooTokenHistoryMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type OhAuthTooTokenHistoryMutationRuleFunc func(context.Context, *generated.OhAuthTooTokenHistoryMutation) error

// EvalMutation calls f(ctx, m).
func (f OhAuthTooTokenHistoryMutationRuleFunc) EvalMutation(ctx context.Context, m generated.Mutation) error {
	if m, ok := m.(*generated.OhAuthTooTokenHistoryMutation); ok {
		return f(ctx, m)
	}
	return Denyf("generated/privacy: unexpected mutation type %T, expect *generated.OhAuthTooTokenHistoryMutation", m)
}
...
// The PasswordResetTokenHistoryQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PasswordResetTokenHistoryQueryRuleFunc func(context.Context, *generated.PasswordResetTokenHistoryQuery) error

// EvalQuery return f(ctx, q).
func (f PasswordResetTokenHistoryQueryRuleFunc) EvalQuery(ctx context.Context, q generated.Query) error {
	if q, ok := q.(*generated.PasswordResetTokenHistoryQuery); ok {
		return f(ctx, q)
	}
	return Denyf("generated/privacy: unexpected query type %T, expect *generated.PasswordResetTokenHistoryQuery", q)
}

// The PasswordResetTokenHistoryMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PasswordResetTokenHistoryMutationRuleFunc func(context.Context, *generated.PasswordResetTokenHistoryMutation) error

// EvalMutation calls f(ctx, m).
func (f PasswordResetTokenHistoryMutationRuleFunc) EvalMutation(ctx context.Context, m generated.Mutation) error {
	if m, ok := m.(*generated.PasswordResetTokenHistoryMutation); ok {
		return f(ctx, m)
	}
	return Denyf("generated/privacy: unexpected mutation type %T, expect *generated.PasswordResetTokenHistoryMutation", m)
}
...
// The PersonalAccessTokenHistoryQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PersonalAccessTokenHistoryQueryRuleFunc func(context.Context, *generated.PersonalAccessTokenHistoryQuery) error

// EvalQuery return f(ctx, q).
func (f PersonalAccessTokenHistoryQueryRuleFunc) EvalQuery(ctx context.Context, q generated.Query) error {
	if q, ok := q.(*generated.PersonalAccessTokenHistoryQuery); ok {
		return f(ctx, q)
	}
	return Denyf("generated/privacy: unexpected query type %T, expect *generated.PersonalAccessTokenHistoryQuery", q)
}

// The PersonalAccessTokenHistoryMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PersonalAccessTokenHistoryMutationRuleFunc func(context.Context, *generated.PersonalAccessTokenHistoryMutation) error

// EvalMutation calls f(ctx, m).
func (f PersonalAccessTokenHistoryMutationRuleFunc) EvalMutation(ctx context.Context, m generated.Mutation) error {
	if m, ok := m.(*generated.PersonalAccessTokenHistoryMutation); ok {
		return f(ctx, m)
	}
	return Denyf("generated/privacy: unexpected mutation type %T, expect *generated.PersonalAccessTokenHistoryMutation", m)
}
...
// The SessionHistoryQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type SessionHistoryQueryRuleFunc func(context.Context, *generated.SessionHistoryQuery) error

// EvalQuery return f(ctx, q).
func (f SessionHistoryQueryRuleFunc) EvalQuery(ctx context.Context, q generated.Query) error {
	if q, ok := q.(*generated.SessionHistoryQuery); ok {
		return f(ctx, q)
	}
	return Denyf("generated/privacy: unexpected query type %T, expect *generated.SessionHistoryQuery", q)
}

// The SessionHistoryMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type SessionHistoryMutationRuleFunc func(context.Context, *generated.SessionHistoryMutation) error

// EvalMutation calls f(ctx, m).
func (f SessionHistoryMutationRuleFunc) EvalMutation(ctx context.Context, m generated.Mutation) error {
	if m, ok := m.(*generated.SessionHistoryMutation); ok {
		return f(ctx, m)
	}
	return Denyf("generated/privacy: unexpected mutation type %T, expect *generated.SessionHistoryMutation", m)
}
...
func mutationFilter(m generated.Mutation) (Filter, error) {
	...
	case *generated.EmailVerificationTokenMutation:
		return m.Filter(), nil
	case *generated.EmailVerificationTokenHistoryMutation:
		return m.Filter(), nil
	...
	case *generated.OhAuthTooTokenMutation:
		return m.Filter(), nil
	case *generated.OhAuthTooTokenHistoryMutation:
		return m.Filter(), nil
	...
	case *generated.PasswordResetTokenMutation:
		return m.Filter(), nil
	case *generated.PasswordResetTokenHistoryMutation:
		return m.Filter(), nil
	case *generated.PersonalAccessTokenMutation:
		return m.Filter(), nil
	case *generated.PersonalAccessTokenHistoryMutation:
		return m.Filter(), nil
	case *generated.SessionMutation:
		return m.Filter(), nil
	case *generated.SessionHistoryMutation:
		return m.Filter(), nil
