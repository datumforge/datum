...
func (*RoleUser) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case roleuser.FieldCreatedBy, roleuser.FieldUpdatedBy, roleuser.FieldRoleID, roleuser.FieldUserID:
...
func (ru *RoleUser) Unwrap() *RoleUser {
	...
	if !ok {
		panic("generated: RoleUser is not a transactional entity")
	}
