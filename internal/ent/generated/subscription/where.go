...
func Cancelled(v bool) predicate.Subscription {
	return predicate.Subscription(sql.FieldEQ(FieldCancelled, v))
}
...
func ExpiresAtIsNil() predicate.Subscription {
	return predicate.Subscription(sql.FieldIsNull(FieldExpiresAt))
}

// ExpiresAtNotNil applies the NotNil predicate on the "expires_at" field.
func ExpiresAtNotNil() predicate.Subscription {
	return predicate.Subscription(sql.FieldNotNull(FieldExpiresAt))
}
...
func CancelledNEQ(v bool) predicate.Subscription {
	return predicate.Subscription(sql.FieldNEQ(FieldCancelled, v))
}
