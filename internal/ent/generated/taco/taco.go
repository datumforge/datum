...
const (
	// Label holds the string label denoting the taco type in the database.
	Label = "taco"
	...
	// Table holds the table name of the taco in the database.
	Table = "tacos"
)

// Columns holds all SQL columns for taco fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
func TierValidator(t Tier) error {
	...
	case TierFree, TierPro, TierEnterprise:
		return nil
	default:
		return fmt.Errorf("taco: invalid enum value for tier field: %q", t)
	}
}

// OrderOption defines the ordering options for the Taco queries.
