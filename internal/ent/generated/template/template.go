...
const (
	...
	// FieldOtherconfig holds the string denoting the otherconfig field in the database.
	FieldOtherconfig = "otherconfig"
...
var (
	...
	DefaultPair func() customtypes.Pair
	// DefaultID holds the default value on creation for the "id" field.
	DefaultID func() string
	// ValueScanner of all Template fields.
	ValueScanner struct {
...
// ByOtherconfig orders the results by the otherconfig field.
func ByOtherconfig(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldOtherconfig, opts...).ToFunc()
}
