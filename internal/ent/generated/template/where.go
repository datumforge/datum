...
// Otherconfig applies equality check predicate on the "otherconfig" field. It's identical to OtherconfigEQ.
func Otherconfig(v *schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldEQ(FieldOtherconfig, v))
}

// Pair applies equality check predicate on the "pair" field. It's identical to PairEQ.
func Pair(v customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldEQ(FieldPair, v))
}

// URL applies equality check predicate on the "url" field. It's identical to URLEQ.
func URL(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	return predicate.TemplateOrErr(sql.FieldEQ(FieldURL, vc), err)
}
...
// OtherconfigEQ applies the EQ predicate on the "otherconfig" field.
func OtherconfigEQ(v *schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldEQ(FieldOtherconfig, v))
}

// OtherconfigNEQ applies the NEQ predicate on the "otherconfig" field.
func OtherconfigNEQ(v *schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldNEQ(FieldOtherconfig, v))
}

// OtherconfigIn applies the In predicate on the "otherconfig" field.
func OtherconfigIn(vs ...*schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldIn(FieldOtherconfig, vs...))
}

// OtherconfigNotIn applies the NotIn predicate on the "otherconfig" field.
func OtherconfigNotIn(vs ...*schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldNotIn(FieldOtherconfig, vs...))
}

// OtherconfigGT applies the GT predicate on the "otherconfig" field.
func OtherconfigGT(v *schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldGT(FieldOtherconfig, v))
}

// OtherconfigGTE applies the GTE predicate on the "otherconfig" field.
func OtherconfigGTE(v *schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldGTE(FieldOtherconfig, v))
}

// OtherconfigLT applies the LT predicate on the "otherconfig" field.
func OtherconfigLT(v *schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldLT(FieldOtherconfig, v))
}

// OtherconfigLTE applies the LTE predicate on the "otherconfig" field.
func OtherconfigLTE(v *schematype.TemplateConfig) predicate.Template {
	return predicate.Template(sql.FieldLTE(FieldOtherconfig, v))
}

// OtherconfigIsNil applies the IsNil predicate on the "otherconfig" field.
func OtherconfigIsNil() predicate.Template {
	return predicate.Template(sql.FieldIsNull(FieldOtherconfig))
}

// OtherconfigNotNil applies the NotNil predicate on the "otherconfig" field.
func OtherconfigNotNil() predicate.Template {
	return predicate.Template(sql.FieldNotNull(FieldOtherconfig))
}

// PairEQ applies the EQ predicate on the "pair" field.
func PairEQ(v customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldEQ(FieldPair, v))
}

// PairNEQ applies the NEQ predicate on the "pair" field.
func PairNEQ(v customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldNEQ(FieldPair, v))
}

// PairIn applies the In predicate on the "pair" field.
func PairIn(vs ...customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldIn(FieldPair, vs...))
}

// PairNotIn applies the NotIn predicate on the "pair" field.
func PairNotIn(vs ...customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldNotIn(FieldPair, vs...))
}

// PairGT applies the GT predicate on the "pair" field.
func PairGT(v customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldGT(FieldPair, v))
}

// PairGTE applies the GTE predicate on the "pair" field.
func PairGTE(v customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldGTE(FieldPair, v))
}

// PairLT applies the LT predicate on the "pair" field.
func PairLT(v customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldLT(FieldPair, v))
}

// PairLTE applies the LTE predicate on the "pair" field.
func PairLTE(v customtypes.Pair) predicate.Template {
	return predicate.Template(sql.FieldLTE(FieldPair, v))
}

// URLEQ applies the EQ predicate on the "url" field.
func URLEQ(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	return predicate.TemplateOrErr(sql.FieldEQ(FieldURL, vc), err)
}

// URLNEQ applies the NEQ predicate on the "url" field.
func URLNEQ(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	return predicate.TemplateOrErr(sql.FieldNEQ(FieldURL, vc), err)
}

// URLIn applies the In predicate on the "url" field.
func URLIn(vs ...*url.URL) predicate.Template {
	var (
		err error
		v   = make([]any, len(vs))
	)
	...
	return predicate.TemplateOrErr(sql.FieldIn(FieldURL, v...), err)
}

// URLNotIn applies the NotIn predicate on the "url" field.
func URLNotIn(vs ...*url.URL) predicate.Template {
	var (
		err error
		v   = make([]any, len(vs))
	)
	...
	return predicate.TemplateOrErr(sql.FieldNotIn(FieldURL, v...), err)
}

// URLGT applies the GT predicate on the "url" field.
func URLGT(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	return predicate.TemplateOrErr(sql.FieldGT(FieldURL, vc), err)
}

// URLGTE applies the GTE predicate on the "url" field.
func URLGTE(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	return predicate.TemplateOrErr(sql.FieldGTE(FieldURL, vc), err)
}

// URLLT applies the LT predicate on the "url" field.
func URLLT(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	return predicate.TemplateOrErr(sql.FieldLT(FieldURL, vc), err)
}

// URLLTE applies the LTE predicate on the "url" field.
func URLLTE(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	return predicate.TemplateOrErr(sql.FieldLTE(FieldURL, vc), err)
}

// URLContains applies the Contains predicate on the "url" field.
func URLContains(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	vcs, ok := vc.(string)
	if err == nil && !ok {
		err = fmt.Errorf("url value is not a string: %T", vc)
	}
	return predicate.TemplateOrErr(sql.FieldContains(FieldURL, vcs), err)
}

// URLHasPrefix applies the HasPrefix predicate on the "url" field.
func URLHasPrefix(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	vcs, ok := vc.(string)
	if err == nil && !ok {
		err = fmt.Errorf("url value is not a string: %T", vc)
	}
	return predicate.TemplateOrErr(sql.FieldHasPrefix(FieldURL, vcs), err)
}

// URLHasSuffix applies the HasSuffix predicate on the "url" field.
func URLHasSuffix(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	vcs, ok := vc.(string)
	if err == nil && !ok {
		err = fmt.Errorf("url value is not a string: %T", vc)
	}
	return predicate.TemplateOrErr(sql.FieldHasSuffix(FieldURL, vcs), err)
}

// URLEqualFold applies the EqualFold predicate on the "url" field.
func URLEqualFold(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	vcs, ok := vc.(string)
	if err == nil && !ok {
		err = fmt.Errorf("url value is not a string: %T", vc)
	}
	return predicate.TemplateOrErr(sql.FieldEqualFold(FieldURL, vcs), err)
}

// URLContainsFold applies the ContainsFold predicate on the "url" field.
func URLContainsFold(v *url.URL) predicate.Template {
	vc, err := ValueScanner.URL.Value(v)
	vcs, ok := vc.(string)
	if err == nil && !ok {
		err = fmt.Errorf("url value is not a string: %T", vc)
	}
	return predicate.TemplateOrErr(sql.FieldContainsFold(FieldURL, vcs), err)
}
