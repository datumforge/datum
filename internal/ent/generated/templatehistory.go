...
func (*TemplateHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case templatehistory.FieldID, templatehistory.FieldRef, templatehistory.FieldCreatedBy, templatehistory.FieldUpdatedBy, templatehistory.FieldDeletedBy, templatehistory.FieldOwnerID, templatehistory.FieldName, templatehistory.FieldDescription:
