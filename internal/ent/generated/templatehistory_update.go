...
func (thu *TemplateHistoryUpdate) ClearJsonconfig() *TemplateHistoryUpdate {
	thu.mutation.ClearJsonconfig()
	return thu
}
...
func (thu *TemplateHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if thu.mutation.JsonconfigCleared() {
		_spec.ClearField(templatehistory.FieldJsonconfig, field.TypeJSON)
	}
...
// ClearJsonconfig clears the value of the "jsonconfig" field.
func (thuo *TemplateHistoryUpdateOne) ClearJsonconfig() *TemplateHistoryUpdateOne {
	thuo.mutation.ClearJsonconfig()
	return thuo
}
...
func (thuo *TemplateHistoryUpdateOne) sqlSave(ctx context.Context) (_node *TemplateHistory, err error) {
	...
	if thuo.mutation.JsonconfigCleared() {
		_spec.ClearField(templatehistory.FieldJsonconfig, field.TypeJSON)
	}
