...
func Oauth(v bool) predicate.UserHistory {
	return predicate.UserHistory(sql.FieldEQ(FieldOauth, v))
}
...
func OauthEQ(v bool) predicate.UserHistory {
	return predicate.UserHistory(sql.FieldEQ(FieldOauth, v))
}

// OauthNEQ applies the NEQ predicate on the "oauth" field.
func OauthNEQ(v bool) predicate.UserHistory {
	return predicate.UserHistory(sql.FieldNEQ(FieldOauth, v))
}
