...
func (uhu *UserHistoryUpdate) SetOauth(b bool) *UserHistoryUpdate {
	uhu.mutation.SetOauth(b)
	return uhu
}

// SetNillableOauth sets the "oauth" field if the given value is not nil.
func (uhu *UserHistoryUpdate) SetNillableOauth(b *bool) *UserHistoryUpdate {
	if b != nil {
		uhu.SetOauth(*b)
	}
	return uhu
...
func (uhu *UserHistoryUpdate) defaults() {
	if _, ok := uhu.mutation.UpdatedAt(); !ok {
...
func (uhu *UserHistoryUpdate) check() error {
	...
	if v, ok := uhu.mutation.FirstName(); ok {
	...
	if v, ok := uhu.mutation.LastName(); ok {
	...
	if v, ok := uhu.mutation.DisplayName(); ok {
	...
	if v, ok := uhu.mutation.AvatarRemoteURL(); ok {
	...
	if v, ok := uhu.mutation.AvatarLocalFile(); ok {
...
func (uhu *UserHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uhu.mutation.Oauth(); ok {
...
// SetOauth sets the "oauth" field.
func (uhuo *UserHistoryUpdateOne) SetOauth(b bool) *UserHistoryUpdateOne {
	uhuo.mutation.SetOauth(b)
	return uhuo
}

// SetNillableOauth sets the "oauth" field if the given value is not nil.
func (uhuo *UserHistoryUpdateOne) SetNillableOauth(b *bool) *UserHistoryUpdateOne {
	if b != nil {
		uhuo.SetOauth(*b)
	}
	return uhuo
...
func (uhuo *UserHistoryUpdateOne) defaults() {
	if _, ok := uhuo.mutation.UpdatedAt(); !ok {
		v := userhistory.UpdateDefaultUpdatedAt()
...
func (uhuo *UserHistoryUpdateOne) check() error {
	if v, ok := uhuo.mutation.Email(); ok {
		if err := userhistory.EmailValidator(v); err != nil {
			return &ValidationError{Name: "email", err: fmt.Errorf(`generated: validator failed for field "UserHistory.email": %w`, err)}
		}
	}
	if v, ok := uhuo.mutation.FirstName(); ok {
		if err := userhistory.FirstNameValidator(v); err != nil {
			return &ValidationError{Name: "first_name", err: fmt.Errorf(`generated: validator failed for field "UserHistory.first_name": %w`, err)}
		}
	}
	if v, ok := uhuo.mutation.LastName(); ok {
		if err := userhistory.LastNameValidator(v); err != nil {
			return &ValidationError{Name: "last_name", err: fmt.Errorf(`generated: validator failed for field "UserHistory.last_name": %w`, err)}
		}
	}
	if v, ok := uhuo.mutation.DisplayName(); ok {
		if err := userhistory.DisplayNameValidator(v); err != nil {
			return &ValidationError{Name: "display_name", err: fmt.Errorf(`generated: validator failed for field "UserHistory.display_name": %w`, err)}
		}
	}
	if v, ok := uhuo.mutation.AvatarRemoteURL(); ok {
		if err := userhistory.AvatarRemoteURLValidator(v); err != nil {
			return &ValidationError{Name: "avatar_remote_url", err: fmt.Errorf(`generated: validator failed for field "UserHistory.avatar_remote_url": %w`, err)}
		}
	}
	if v, ok := uhuo.mutation.AvatarLocalFile(); ok {
		if err := userhistory.AvatarLocalFileValidator(v); err != nil {
			return &ValidationError{Name: "avatar_local_file", err: fmt.Errorf(`generated: validator failed for field "UserHistory.avatar_local_file": %w`, err)}
		}
	}
...
func (uhuo *UserHistoryUpdateOne) sqlSave(ctx context.Context) (_node *UserHistory, err error) {
	...
	if value, ok := uhuo.mutation.Oauth(); ok {
		_spec.SetField(userhistory.FieldOauth, field.TypeBool, value)
	}
