...
func (urc *UserRoleCreate) defaults() error {
	if _, ok := urc.mutation.CreatedAt(); !ok {
		if userrole.DefaultCreatedAt == nil {
			return fmt.Errorf("generated: uninitialized userrole.DefaultCreatedAt (forgotten import generated/runtime?)")
		}
	...
	if _, ok := urc.mutation.UpdatedAt(); !ok {
		if userrole.DefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized userrole.DefaultUpdatedAt (forgotten import generated/runtime?)")
		}
	...
	if _, ok := urc.mutation.ID(); !ok {
		if userrole.DefaultID == nil {
			return fmt.Errorf("generated: uninitialized userrole.DefaultID (forgotten import generated/runtime?)")
		}
...
func (urc *UserRoleCreate) check() error {
	...
	if _, ok := urc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user", err: errors.New(`generated: missing required edge "UserRole.user"`)}
	}
	if _, ok := urc.mutation.RoleID(); !ok {
		return &ValidationError{Name: "role", err: errors.New(`generated: missing required edge "UserRole.role"`)}
	}
	return nil
}
...
func (urc *UserRoleCreate) createSpec() (*UserRole, *sqlgraph.CreateSpec) {
	...
	_spec.Schema = urc.schemaConfig.UserRole
	...
	if nodes := urc.mutation.UserIDs(); len(nodes) > 0 {
		...
		edge.Schema = urc.schemaConfig.UserRole
		for _, k := range nodes {
