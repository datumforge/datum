...
func (uru *UserRoleUpdate) defaults() error {
	if _, ok := uru.mutation.UpdatedAt(); !ok {
		if userrole.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized userrole.UpdateDefaultUpdatedAt (forgotten import generated/runtime?)")
		}
...
func (uru *UserRoleUpdate) check() error {
	if _, ok := uru.mutation.UserID(); uru.mutation.UserCleared() && !ok {
		return errors.New(`generated: clearing a required unique edge "UserRole.user"`)
	}
	if _, ok := uru.mutation.RoleID(); uru.mutation.RoleCleared() && !ok {
		return errors.New(`generated: clearing a required unique edge "UserRole.role"`)
	}
	return nil
}
...
func (uru *UserRoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uru.mutation.UserCleared() {
		...
		edge.Schema = uru.schemaConfig.UserRole
	...
	_spec.Node.Schema = uru.schemaConfig.UserRole
...
func (uruo *UserRoleUpdateOne) sqlSave(ctx context.Context) (_node *UserRole, err error) {
	...
	if uruo.mutation.UserCleared() {
		...
		edge.Schema = uruo.schemaConfig.UserRole
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	...
	_spec.Node.Schema = uruo.schemaConfig.UserRole
