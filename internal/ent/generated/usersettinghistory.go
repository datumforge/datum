...
func (*UserSettingHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case usersettinghistory.FieldPermissions, usersettinghistory.FieldTags:
			values[i] = new([]byte)
		case usersettinghistory.FieldLocked, usersettinghistory.FieldEmailConfirmed:
			values[i] = new(sql.NullBool)
		case usersettinghistory.FieldID, usersettinghistory.FieldOperation, usersettinghistory.FieldRef, usersettinghistory.FieldCreatedBy, usersettinghistory.FieldUpdatedBy, usersettinghistory.FieldDeletedBy, usersettinghistory.FieldRecoveryCode, usersettinghistory.FieldStatus, usersettinghistory.FieldRole:
	...
	for i := range columns {
		...
		case usersettinghistory.FieldOperation:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				ush.Operation = enthistory.OpType(value.String)
			}
		...
		case usersettinghistory.FieldStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				ush.Status = usersettinghistory.Status(value.String)
			}
		case usersettinghistory.FieldRole:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field role", values[i])
			} else if value.Valid {
				ush.Role = usersettinghistory.Role(value.String)
			}
		case usersettinghistory.FieldPermissions:
			if value, ok := values[i].(*[]byte); !ok {
				return fmt.Errorf("unexpected type %T for field permissions", values[i])
			} else if value != nil && len(*value) > 0 {
				if err := json.Unmarshal(*value, &ush.Permissions); err != nil {
...
func (ush *UserSettingHistory) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", ush.Role))
	builder.WriteString(", ")
	builder.WriteString("permissions=")
	builder.WriteString(fmt.Sprintf("%v", ush.Permissions))
	builder.WriteString(", ")
