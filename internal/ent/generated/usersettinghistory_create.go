...
func (ushc *UserSettingHistoryCreate) SetStatus(u usersettinghistory.Status) *UserSettingHistoryCreate {
	ushc.mutation.SetStatus(u)
	return ushc
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (ushc *UserSettingHistoryCreate) SetNillableStatus(u *usersettinghistory.Status) *UserSettingHistoryCreate {
	if u != nil {
		ushc.SetStatus(*u)
	}
	return ushc
...
func (ushc *UserSettingHistoryCreate) SetRole(u usersettinghistory.Role) *UserSettingHistoryCreate {
	ushc.mutation.SetRole(u)
	return ushc
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (ushc *UserSettingHistoryCreate) SetNillableRole(u *usersettinghistory.Role) *UserSettingHistoryCreate {
	if u != nil {
		ushc.SetRole(*u)
	}
	return ushc
...
func (ushc *UserSettingHistoryCreate) SetPermissions(s []string) *UserSettingHistoryCreate {
	ushc.mutation.SetPermissions(s)
	return ushc
}
...
func (ushc *UserSettingHistoryCreate) defaults() {
	...
	if _, ok := ushc.mutation.Role(); !ok {
		v := usersettinghistory.DefaultRole
		ushc.mutation.SetRole(v)
	}
	if _, ok := ushc.mutation.Permissions(); !ok {
		v := usersettinghistory.DefaultPermissions
		ushc.mutation.SetPermissions(v)
	}
...
func (ushc *UserSettingHistoryCreate) check() error {
	...
	if _, ok := ushc.mutation.Role(); !ok {
		return &ValidationError{Name: "role", err: errors.New(`generated: missing required field "UserSettingHistory.role"`)}
	}
	if v, ok := ushc.mutation.Role(); ok {
	...
	if _, ok := ushc.mutation.Permissions(); !ok {
		return &ValidationError{Name: "permissions", err: errors.New(`generated: missing required field "UserSettingHistory.permissions"`)}
	}
	if _, ok := ushc.mutation.EmailConfirmed(); !ok {
...
func (ushc *UserSettingHistoryCreate) createSpec() (*UserSettingHistory, *sqlgraph.CreateSpec) {
	...
	if value, ok := ushc.mutation.Role(); ok {
		_spec.SetField(usersettinghistory.FieldRole, field.TypeEnum, value)
		_node.Role = value
	}
	if value, ok := ushc.mutation.Permissions(); ok {
