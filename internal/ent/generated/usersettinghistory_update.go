...
func (ushu *UserSettingHistoryUpdate) SetRecoveryCode(s string) *UserSettingHistoryUpdate {
	ushu.mutation.SetRecoveryCode(s)
	return ushu
}

// SetNillableRecoveryCode sets the "recovery_code" field if the given value is not nil.
func (ushu *UserSettingHistoryUpdate) SetNillableRecoveryCode(s *string) *UserSettingHistoryUpdate {
	if s != nil {
		ushu.SetRecoveryCode(*s)
	}
	return ushu
}

// ClearRecoveryCode clears the value of the "recovery_code" field.
func (ushu *UserSettingHistoryUpdate) ClearRecoveryCode() *UserSettingHistoryUpdate {
	ushu.mutation.ClearRecoveryCode()
	return ushu
}

// SetStatus sets the "status" field.
func (ushu *UserSettingHistoryUpdate) SetStatus(u usersettinghistory.Status) *UserSettingHistoryUpdate {
	ushu.mutation.SetStatus(u)
	return ushu
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (ushu *UserSettingHistoryUpdate) SetNillableStatus(u *usersettinghistory.Status) *UserSettingHistoryUpdate {
	if u != nil {
		ushu.SetStatus(*u)
	}
	return ushu
...
func (ushu *UserSettingHistoryUpdate) SetRole(u usersettinghistory.Role) *UserSettingHistoryUpdate {
	ushu.mutation.SetRole(u)
	return ushu
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (ushu *UserSettingHistoryUpdate) SetNillableRole(u *usersettinghistory.Role) *UserSettingHistoryUpdate {
	if u != nil {
		ushu.SetRole(*u)
	}
	return ushu
...
func (ushu *UserSettingHistoryUpdate) SetPermissions(s []string) *UserSettingHistoryUpdate {
	ushu.mutation.SetPermissions(s)
	return ushu
}

// AppendPermissions appends s to the "permissions" field.
func (ushu *UserSettingHistoryUpdate) AppendPermissions(s []string) *UserSettingHistoryUpdate {
	ushu.mutation.AppendPermissions(s)
	return ushu
}
...
func (ushu *UserSettingHistoryUpdate) check() error {
	...
	if v, ok := ushu.mutation.Role(); ok {
		if err := usersettinghistory.RoleValidator(v); err != nil {
			return &ValidationError{Name: "role", err: fmt.Errorf(`generated: validator failed for field "UserSettingHistory.role": %w`, err)}
		}
	}
	return nil
}
...
func (ushu *UserSettingHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ushu.mutation.RecoveryCode(); ok {
		_spec.SetField(usersettinghistory.FieldRecoveryCode, field.TypeString, value)
	}
	if ushu.mutation.RecoveryCodeCleared() {
		_spec.ClearField(usersettinghistory.FieldRecoveryCode, field.TypeString)
	}
	if value, ok := ushu.mutation.Status(); ok {
		_spec.SetField(usersettinghistory.FieldStatus, field.TypeEnum, value)
	}
	if value, ok := ushu.mutation.Role(); ok {
		_spec.SetField(usersettinghistory.FieldRole, field.TypeEnum, value)
	}
	if value, ok := ushu.mutation.Permissions(); ok {
		_spec.SetField(usersettinghistory.FieldPermissions, field.TypeJSON, value)
	}
	if value, ok := ushu.mutation.AppendedPermissions(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, usersettinghistory.FieldPermissions, value)
		})
	}
...
// SetRecoveryCode sets the "recovery_code" field.
func (ushuo *UserSettingHistoryUpdateOne) SetRecoveryCode(s string) *UserSettingHistoryUpdateOne {
	ushuo.mutation.SetRecoveryCode(s)
	return ushuo
}

// SetNillableRecoveryCode sets the "recovery_code" field if the given value is not nil.
func (ushuo *UserSettingHistoryUpdateOne) SetNillableRecoveryCode(s *string) *UserSettingHistoryUpdateOne {
	if s != nil {
		ushuo.SetRecoveryCode(*s)
	}
	return ushuo
}

// ClearRecoveryCode clears the value of the "recovery_code" field.
func (ushuo *UserSettingHistoryUpdateOne) ClearRecoveryCode() *UserSettingHistoryUpdateOne {
	ushuo.mutation.ClearRecoveryCode()
	return ushuo
}

// SetStatus sets the "status" field.
func (ushuo *UserSettingHistoryUpdateOne) SetStatus(u usersettinghistory.Status) *UserSettingHistoryUpdateOne {
	ushuo.mutation.SetStatus(u)
	return ushuo
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (ushuo *UserSettingHistoryUpdateOne) SetNillableStatus(u *usersettinghistory.Status) *UserSettingHistoryUpdateOne {
	if u != nil {
		ushuo.SetStatus(*u)
	}
	return ushuo
...
// SetRole sets the "role" field.
func (ushuo *UserSettingHistoryUpdateOne) SetRole(u usersettinghistory.Role) *UserSettingHistoryUpdateOne {
	ushuo.mutation.SetRole(u)
	return ushuo
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (ushuo *UserSettingHistoryUpdateOne) SetNillableRole(u *usersettinghistory.Role) *UserSettingHistoryUpdateOne {
	if u != nil {
		ushuo.SetRole(*u)
	}
	return ushuo
...
// SetPermissions sets the "permissions" field.
func (ushuo *UserSettingHistoryUpdateOne) SetPermissions(s []string) *UserSettingHistoryUpdateOne {
	ushuo.mutation.SetPermissions(s)
	return ushuo
}

// AppendPermissions appends s to the "permissions" field.
func (ushuo *UserSettingHistoryUpdateOne) AppendPermissions(s []string) *UserSettingHistoryUpdateOne {
	ushuo.mutation.AppendPermissions(s)
	return ushuo
}
...
func (ushuo *UserSettingHistoryUpdateOne) check() error {
	...
	if v, ok := ushuo.mutation.Role(); ok {
		if err := usersettinghistory.RoleValidator(v); err != nil {
			return &ValidationError{Name: "role", err: fmt.Errorf(`generated: validator failed for field "UserSettingHistory.role": %w`, err)}
		}
	}
...
func (ushuo *UserSettingHistoryUpdateOne) sqlSave(ctx context.Context) (_node *UserSettingHistory, err error) {
	...
	if value, ok := ushuo.mutation.RecoveryCode(); ok {
		_spec.SetField(usersettinghistory.FieldRecoveryCode, field.TypeString, value)
	}
	if ushuo.mutation.RecoveryCodeCleared() {
		_spec.ClearField(usersettinghistory.FieldRecoveryCode, field.TypeString)
	}
	if value, ok := ushuo.mutation.Status(); ok {
		_spec.SetField(usersettinghistory.FieldStatus, field.TypeEnum, value)
	}
	if value, ok := ushuo.mutation.Role(); ok {
		_spec.SetField(usersettinghistory.FieldRole, field.TypeEnum, value)
	}
	if value, ok := ushuo.mutation.Permissions(); ok {
		_spec.SetField(usersettinghistory.FieldPermissions, field.TypeJSON, value)
	}
	if value, ok := ushuo.mutation.AppendedPermissions(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, usersettinghistory.FieldPermissions, value)
		})
	}
