...
func (ushu *UserSettingHistoryUpdate) SetDefaultOrg(s string) *UserSettingHistoryUpdate {
	ushu.mutation.SetDefaultOrg(s)
	return ushu
}

// SetNillableDefaultOrg sets the "default_org" field if the given value is not nil.
func (ushu *UserSettingHistoryUpdate) SetNillableDefaultOrg(s *string) *UserSettingHistoryUpdate {
	if s != nil {
		ushu.SetDefaultOrg(*s)
	}
	return ushu
}

// ClearDefaultOrg clears the value of the "default_org" field.
func (ushu *UserSettingHistoryUpdate) ClearDefaultOrg() *UserSettingHistoryUpdate {
	ushu.mutation.ClearDefaultOrg()
	return ushu
}
...
func (ushu *UserSettingHistoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ushu.mutation.DefaultOrg(); ok {
		_spec.SetField(usersettinghistory.FieldDefaultOrg, field.TypeString, value)
	}
	if ushu.mutation.DefaultOrgCleared() {
		_spec.ClearField(usersettinghistory.FieldDefaultOrg, field.TypeString)
	}
...
// SetDefaultOrg sets the "default_org" field.
func (ushuo *UserSettingHistoryUpdateOne) SetDefaultOrg(s string) *UserSettingHistoryUpdateOne {
	ushuo.mutation.SetDefaultOrg(s)
	return ushuo
}

// SetNillableDefaultOrg sets the "default_org" field if the given value is not nil.
func (ushuo *UserSettingHistoryUpdateOne) SetNillableDefaultOrg(s *string) *UserSettingHistoryUpdateOne {
	if s != nil {
		ushuo.SetDefaultOrg(*s)
	}
	return ushuo
}

// ClearDefaultOrg clears the value of the "default_org" field.
func (ushuo *UserSettingHistoryUpdateOne) ClearDefaultOrg() *UserSettingHistoryUpdateOne {
	ushuo.mutation.ClearDefaultOrg()
	return ushuo
}
...
func (ushuo *UserSettingHistoryUpdateOne) sqlSave(ctx context.Context) (_node *UserSettingHistory, err error) {
	...
	if value, ok := ushuo.mutation.DefaultOrg(); ok {
		_spec.SetField(usersettinghistory.FieldDefaultOrg, field.TypeString, value)
	}
	if ushuo.mutation.DefaultOrgCleared() {
		_spec.ClearField(usersettinghistory.FieldDefaultOrg, field.TypeString)
	}
