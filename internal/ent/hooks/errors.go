...
var (
	...
	// ErrMissingRequiredName is returned when neither a name or display name is required but not provided
	ErrMissingRequiredName = errors.New("recipient name or display name required but not provided")
)
