...
func (suite *GraphTestSuite) TestQueryTFASetting() {
	...
	for _, tc := range testCases {
		t.Run("Get "+tc.name, func(t *testing.T) {
			...
			resp, err := suite.client.datum.GetTFASettings(reqCtx)
...
func (suite *GraphTestSuite) TestMutationCreateTFASetting() {
	...
	for _, tc := range testCases {
		t.Run("Create "+tc.name, func(t *testing.T) {
			// update user
			resp, err := suite.client.datum.CreateTFASettings(reqCtx, tc.input)
...
func (suite *GraphTestSuite) TestMutationUpdateTFASetting() {
	...
	for _, tc := range testCases {
		t.Run("Update "+tc.name, func(t *testing.T) {
			...
			// update user
			resp, err := suite.client.datum.UpdateTFASettings(reqCtx, tc.input)
