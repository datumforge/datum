...
func EchoWrapHandler(options ...func(*Config)) echo.HandlerFunc {
	...
	return func(c echo.Context) error {
		...
		case ".html":
			c.Response().Header().Set(content, "text/html; charset=utf-8")
		case ".css":
			c.Response().Header().Set(content, "text/css; charset=utf-8")
		case ".js":
			c.Response().Header().Set(content, "application/javascript")
		case ".json":
			c.Response().Header().Set(content, "application/json; charset=utf-8")
		case ".yaml":
			c.Response().Header().Set(content, "text/plain; charset=utf-8")
		case ".png":
			c.Response().Header().Set(content, "image/png")
		}
