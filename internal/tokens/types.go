...
// TimePrecision sets the precision of times and dates; the default precision is set to seconds, so that no fractional timestamps are generated
...
func newNumericDateFromSeconds(f float64) *NumericDate {
	...
	return NewNumericDate(time.Unix(int64(round), int64(frac*1e9))) //nolint:gomnd
}
