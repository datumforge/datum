...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/agreements"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/agreements/generate/datum.agreements.json"
	yamlConfigPath = "./jsonschema/models/agreements/generate/datum.agreements.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &agreements.Config{}); err != nil {
		panic(err)
	}
}
