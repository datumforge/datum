...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/cloud"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/cloud/generate/datum.cloud.json"
	yamlConfigPath = "./jsonschema/models/cloud/generate/datum.cloud.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &cloud.Config{}); err != nil {
		panic(err)
	}
}
