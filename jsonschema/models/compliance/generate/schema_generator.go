...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/compliance"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/compliance/generate/datum.compliance.json"
	yamlConfigPath = "./jsonschema/models/compliance/generate/datum.compliance.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &compliance.Config{}); err != nil {
		panic(err)
	}
}
