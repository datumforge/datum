...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/email"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/email/generate/datum.email.json"
	yamlConfigPath = "./jsonschema/models/email/generate/datum.email.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &email.Config{}); err != nil {
		panic(err)
	}
}
