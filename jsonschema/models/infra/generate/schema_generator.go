...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/infra"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/infra/generate/datum.infra.json"
	yamlConfigPath = "./jsonschema/models/infra/generate/datum.infra.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &infra.Config{}); err != nil {
		panic(err)
	}
}
