...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/invoice"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/invoice/generate/datum.invoice.json"
	yamlConfigPath = "./jsonschema/models/invoice/generate/datum.invoice.yaml"
	ownerReadWrite = 0600
)
