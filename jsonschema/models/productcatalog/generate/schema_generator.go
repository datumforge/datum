...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/productcatalog"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/productcatalog/generate/datum.productcatalog.json"
	yamlConfigPath = "./jsonschema/models/productcatalog/generate/datum.productcatalog.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &productcatalog.Config{}); err != nil {
		panic(err)
	}
}
...
func generateSchema(c schemaConfig, structure interface{}) error {
	...
	if err := r.AddGoComments("github.com/datumforge/datum/", "./"); err != nil {
		panic(err.Error())
	}
	...
	yamlConfig := &productcatalog.Config{}
