...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/subscriptions"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/subscriptions/generate/datum.subscriptions.json"
	yamlConfigPath = "./jsonschema/models/subscriptions/generate/datum.subscriptions.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &subscriptions.Config{}); err != nil {
		panic(err)
	}
}
...
func generateSchema(c schemaConfig, structure interface{}) error {
	...
	yamlConfig := &subscriptions.Config{}
