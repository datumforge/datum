...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/webhook"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/webhook/generate/datum.webhook.json"
	yamlConfigPath = "./jsonschema/models/webhook/generate/datum.webhook.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &webhook.Config{}); err != nil {
		panic(err)
	}
}
