...
import (
	...
	"github.com/datumforge/datum/jsonschema/models/workrequests"
)
...
const (
	...
	skipper        = "-"
	defaultTag     = "default"
	jsonSchemaPath = "./jsonschema/models/workrequests/generate/datum.workrequests.json"
	yamlConfigPath = "./jsonschema/models/workrequests/generate/datum.workrequests.yaml"
	ownerReadWrite = 0600
)
...
func main() {
	...
	if err := generateSchema(c, &workrequests.Config{}); err != nil {
		panic(err)
	}
}
...
func generateSchema(c schemaConfig, structure interface{}) error {
	...
	yamlConfig := &workrequests.Config{}
