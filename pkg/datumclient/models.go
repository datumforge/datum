...
type CreateTemplateInput struct {
	...
	Otherconfig json.RawMessage `json:"otherconfig,omitempty"`
...
type TemplateWhereInput struct {
	...
	Otherconfig       json.RawMessage   `json:"otherconfig,omitempty"`
	OtherconfigNeq    json.RawMessage   `json:"otherconfigNEQ,omitempty"`
	OtherconfigIn     []json.RawMessage `json:"otherconfigIn,omitempty"`
	OtherconfigNotIn  []json.RawMessage `json:"otherconfigNotIn,omitempty"`
	OtherconfigGt     json.RawMessage   `json:"otherconfigGT,omitempty"`
	OtherconfigGte    json.RawMessage   `json:"otherconfigGTE,omitempty"`
	OtherconfigLt     json.RawMessage   `json:"otherconfigLT,omitempty"`
	OtherconfigLte    json.RawMessage   `json:"otherconfigLTE,omitempty"`
	...
	URLNeq          json.RawMessage   `json:"urlNEQ,omitempty"`
	URLIn           []json.RawMessage `json:"urlIn,omitempty"`
	URLNotIn        []json.RawMessage `json:"urlNotIn,omitempty"`
	URLGt           json.RawMessage   `json:"urlGT,omitempty"`
	URLGte          json.RawMessage   `json:"urlGTE,omitempty"`
	URLLt           json.RawMessage   `json:"urlLT,omitempty"`
	URLLte          json.RawMessage   `json:"urlLTE,omitempty"`
	URLContains     json.RawMessage   `json:"urlContains,omitempty"`
	URLHasPrefix    json.RawMessage   `json:"urlHasPrefix,omitempty"`
	URLHasSuffix    json.RawMessage   `json:"urlHasSuffix,omitempty"`
	URLEqualFold    json.RawMessage   `json:"urlEqualFold,omitempty"`
	URLContainsFold json.RawMessage   `json:"urlContainsFold,omitempty"`
	// owner edge predicates
	HasOwner     *bool                     `json:"hasOwner,omitempty"`
	HasOwnerWith []*OrganizationWhereInput `json:"hasOwnerWith,omitempty"`
}
